...
public class JFrameTest2 extends JFrame implements ActionListener{
     ...
     * "Quit" disposes of the JFrame "Help" 
     * Executes the Help JDialog "About"
     ...
     * Action performed, it disposes of the JDialog. The JButton is labeled "Help Me!".
     * Location is set to relative (movable) and visible
     */
     ...
     * Action performed, it disposes of the JDialog. On the JButton there is a JLabel with
     * some interesting details about the programmers. Location is set to
    ...
    private void aboutDialog()
    {
        ...
        JButton helpButton = new JButton ("<html> <p> Filip and Erfan are considered to be very not awesome people <br>   " +
