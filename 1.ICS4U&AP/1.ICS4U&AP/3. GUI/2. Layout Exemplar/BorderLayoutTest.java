...
public class BorderLayoutTest extends JFrame implements ActionListener
{
	...
	super ("Testing Out BorderLayout");
	...
	JButton nButton = new JButton ("Increase Space Between Buttons");
	JButton sButton = new JButton ("Decrease Space Between Buttons");
	JButton eButton = new JButton ("Alignment");
	JButton wButton = new JButton ("Gap Sizes");
